...
// Técnicas anti-detecção (mesmas do scraper)
...
const queryParams = {
  ...
  sessionTTL: 900,
  sessionName: "STJ Full Config Test",
...
console.log("🛡️ Aplicando técnicas anti-detecção...");
...
// Screenshot final
await page.screenshot({ path: "stj-full-config-test.png", fullPage: true });
